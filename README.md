...
이 파일은 기본적으로 Local에서 사용하는 것을 골자로 합니다.
사용을 위해서는, GitHub에 동봉되어 있는 build.zip 파일을 이용해야 합니다.

build.zip의 압축을 해제한 후, 폴더 내에 있는 MSC.html 파일을 열면
파일을 정상적으로 이용할 수 있습니다.

물론 이 파일은 npm을 통해 build했기 때문에
npm 명령어를 사용해 build해서 사용하는 것 또한 가능합니다.
